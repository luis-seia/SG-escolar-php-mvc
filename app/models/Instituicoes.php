...
class Instituicoes extends Database {

    public function findById($id) {
        $query = "SELECT * FROM instituicao WHERE id = ?";
    ...
    public function findByEmail($email) {
        $query = "SELECT * FROM instituicao WHERE email = ?";
    ...
    public function add($name, $email, $password) {
        ...
        $query = "INSERT INTO instituicao(nome, email, password) VALUES (?,?,?)";
